...
plot(mean(d_H_norm(1,:,:),3)+std(d_H_norm(1,:,:),0,3),'r')
plot(mean(d_H_norm(2,:,:),3)+std(d_H_norm(2,:,:),0,3),'b')
plot(mean(d_H_norm(1,:,:),3)-std(d_H_norm(1,:,:),0,3),'r')
plot(mean(d_H_norm(2,:,:),3)-std(d_H_norm(2,:,:),0,3),'b')
...
plot(mean(d_cosine(1,:,:),3)+std(d_cosine(1,:,:),0,3),'r')
plot(mean(d_cosine(2,:,:),3)+std(d_cosine(2,:,:),0,3),'b')
plot(mean(d_cosine(1,:,:),3)-std(d_cosine(1,:,:),0,3),'r')
plot(mean(d_cosine(2,:,:),3)-std(d_cosine(2,:,:),0,3),'b')
plot([100 100],[-0.2 1],'--k')
plot([0 200],[0 0],'k')
